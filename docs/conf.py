...
"""
edx-rbac documentation build configuration file.
...
#
html_theme_options = {
 "repository_url": "https://github.com/openedx/edx-rbac",
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'Library to help managing role based access controls for django apps',
     'Miscellaneous'),
]
